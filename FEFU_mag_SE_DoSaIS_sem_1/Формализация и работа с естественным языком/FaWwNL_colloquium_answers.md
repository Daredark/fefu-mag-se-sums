...
Добавить разделение вопросов по трем темам.
...
11. 1320 chars (completed, normalize length) (strong)
...
15. 842 chars (completed, normalize length) (strong)
...
20. 149 chars (completed, normalize length) (WAY TOO STRONG, but not for the right reasons) (only a part of the answer is available)
...
## __15. Функциональная природа языка. (WIP - completed, normalize length) (842 chars) (Topic 3: pra8: 24. -> 27.)__
